...
public class KeggInfoProvider {
	...
	public static String[] getNamesForKEGGID(String keggID) throws IOException {
		...
		if(nameString==null || nameString.isEmpty()){
			String url = KEGG_REST + "find/compound/" + keggID;
	...
	private static byte[] getImageFromURL(String url) {
		...
		if(LayoutVisualizerGUI.getProxy()!=null)
			client.getParams().setParameter("http.route.default-proxy",LayoutVisualizerGUI.getProxy());
