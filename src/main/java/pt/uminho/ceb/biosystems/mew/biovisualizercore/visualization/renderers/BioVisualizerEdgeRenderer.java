...
public class BioVisualizerEdgeRenderer extends AbstractShapeRenderer{
	
	 public static final String EDGE_TYPE = "edgeType";
	 public static final String EDGE_WITH = "edge_with";   
	 public static final String EDGE_SHAPE = "edgeShape";
	    ...
	    protected double  m_width     = 1 * size;
	    protected float   m_curWidth  = 1 * size;
...
//	    protected int     m_edgeArrow   = Constants.EDGE_ARROW_FORWARD;
	     ...
	     */
	    public BioVisualizerEdgeRenderer() {
...
//	    }
	     ...
	     */
	    public BioVisualizerEdgeRenderer(int edgeType) {
	        this();
...
//	        setArrowType(arrowType);
	     ...
	     */
	    public int getRenderType2(VisualItem item) {
	    ...
	    protected Shape getRawShape(VisualItem item) {
	        ...
	        /*
	         * Substituir por item.getArrowShape!
	         */
	        int type = m_edgeType;
//	        int type = item.getInt(EDGE_SHAPE);
