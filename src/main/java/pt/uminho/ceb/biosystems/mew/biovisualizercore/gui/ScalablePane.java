...
public class ScalablePane extends JPanel implements ComponentListener{
    ...
    public ScalablePane(Image master) {
        this(master,null, true);
    }

    public ScalablePane(Image master, JComponent parent, boolean toFit) {
        this.master = master;
        this.parent = parent;
        setToFit(toFit);
    }
...
//    	int masterWidth = master.getWidth(this);
//    	int masterHeight = master.getHeight(this);
//    	double aspectRatio = masterHeight/masterWidth;
//    	
//    	int parentWidth = parent.getWidth();
//    	int targetHeight = (int) (parentWidth * aspectRatio);
//    	
//    	return new Dimension(parentWidth,targetHeight);
//    }
...
//                }
                ...
                try {
                    BufferedImage image = ImageIO.read(new File("/home/pmaia/Desktop/Java_1.jpg"));
                    ...
                    split2.setTopComponent(new ScalablePane(image,null,true));
                    split2.setBottomComponent(new JLabel("RIGHT BOTTOM"));
