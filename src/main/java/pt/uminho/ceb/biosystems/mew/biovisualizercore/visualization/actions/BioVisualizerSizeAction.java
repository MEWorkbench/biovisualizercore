...
public class BioVisualizerSizeAction extends SizeAction{
...
protected static final double NO_SIZE = Double.NaN;
     ...
     */
    public BioVisualizerSizeAction(String group, String field) {
        super(group, NO_SIZE);
        m_dataField = field;
    }
     ...
     */
    public BioVisualizerSizeAction(String group, String field, int bins) {
     ...
     */
    public BioVisualizerSizeAction(String group, String field, int bins, int scale) {
        super(group, NO_SIZE);
        m_dataField = field;
        setScale(scale);
        setBinCount(bins);
